...
extern void rubyToggleSetLevelScheme(int scheme);
...
static int setRubyToggleObscureStyle(lua_State *L)
{
    int style = luaL_checkint(L, 2);
    rubyToggleSetObscureStyle(style);
    return 0;
}
...
static int setRubyToggleFogParams(lua_State *L)
{
...
static int setRubyToggleLevelScheme(lua_State *L)
{
    int scheme = luaL_checkint(L, 2);
    rubyToggleSetLevelScheme(scheme);
    return 0;
}
...
static const struct luaL_Reg credocument_meth[] = {
    ...
    {"setRubyToggleLevelScheme", setRubyToggleLevelScheme},
